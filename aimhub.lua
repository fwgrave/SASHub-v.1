    ...
    Author: Grave (yurzki.)
    License: MIT
    GitHub: https://github.com/fwgrave/SASHub-v.1
Issues in the discord: https://discord.gg/pcg4kbKm
...
do
    ...
    Tabs.Aimbot:AddParagraph({
        Title = string.format("%s 🔥PAID🔥", string.format(MonthlyLabels[os.date("*t").month], "Open Aimbot")),
        Content = "💀SAS Paid Aimbot💀"
    })
    ...
    Tabs.Bots:AddParagraph({
        Title = string.format("%s 💀Paid💀", string.format(MonthlyLabels[os.date("*t").month], "Open Aimbot")),
        Content = "💀SAS Paid Aimbot V1💀 (https://discord.gg/pcg4kbKm)"
    })
    ...
    SpinBotSection:AddButton({
        ...
        Callback = function()
            ...
            SpinPartDropdown:SetValues(Configuration.SpinPartDropdownValues)
            Window:Dialog({
                Title = string.format(MonthlyLabels[os.date("*t").month], "Paid Aimbot"),
                Content = Items == 0 and "Nothing has been cleared!" or Items == 1 and "1 Item has been cleared!" or string.format("%s Items have been cleared!", Items),
                Buttons = {
                    {
                        Title = "Confirm"
    ...
    Tabs.Checks = Window:AddTab({ Title = "Lowk Broken", Icon = "list-checks" })

    Tabs.Checks:AddParagraph({
        Title = string.format("%s 🔥Paid🔥", string.format(MonthlyLabels[os.date("*t").month], "Open Aimbot")),
        Content = "💀SAS Paid Universal💀"
    })
    ...
    Tabs.Settings:AddParagraph({
        Title = string.format("%s 🔥Paid🔥", string.format(MonthlyLabels[os.date("*t").month], "Open Aimbot")),
        Content = "💀SAS Paid Universal Aimbot"
    })
    ...
    if getfenv().setclipboard then
        DiscordWikiSection:AddButton({
            ...
            Callback = function()
                getfenv().setclipboard("https://discord.gg/pcg4kbKm")
                Window:Dialog({
                    Title = string.format(MonthlyLabels[os.date("*t").month], "Open Aimbot"),
        ...
        DiscordWikiSection:AddParagraph({
            Title = https://discord.gg/pcg4kbKm",
